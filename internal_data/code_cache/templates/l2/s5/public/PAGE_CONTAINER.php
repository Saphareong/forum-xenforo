<?php
// FROM HASH: ce8b952d87a47d066175f64e2037206b
...
';
	...
	if ($__vars['xf']['visitor']['is_moderator']) {
		$__compilerTemp2 .= '
								<a href="' . $__templater->fn('link', array('approval-queue', ), true) . '" class="menu-linkRow">' . 'Đang chờ phê duyệt' . '</a>
							';
	}
	$__compilerTemp2 .= '
							';
...
';
	...
	<div class="p-header-inner">
		<div class="p-header-content">
			...
			';
	if ($__templater->fn('property', array('dt_text_logo', ), false)) {
		$__finalCompiled .= '
			<div class="p-header-logo p-header-logo--text">
				<a href="' . (($__vars['xf']['options']['logoLink'] AND $__vars['xf']['homePageUrl']) ? $__templater->escape($__vars['xf']['homePageUrl']) : $__templater->fn('link', array('index', ), true)) . '">
						' . $__templater->fn('property', array('dt_text_logo', ), true) . '
				</a>
			</div>
			';
	} else {
	...
	if ($__vars['xf']['visitor']['user_id']) {
		...
		if (($__vars['xf']['visitor']['user_state'] == 'rejected') OR ($__vars['xf']['visitor']['user_state'] == 'disabled')) {
			...
			$__compilerTemp4 .= '
									<a href="' . $__templater->fn('link', array('account', ), true) . '"
										class="p-navgroup-link p-navgroup-link--iconic p-navgroup-link--user badgeContainer';
			if ($__vars['xf']['visitor']['conversations_unread'] OR $__vars['xf']['visitor']['alerts_unread']) {
				$__compilerTemp4 .= ' badgeContainer--highlighted';
			}
			$__compilerTemp4 .= '"
										data-badge="' . $__templater->filter($__vars['xf']['visitor']['conversations_unread'] + $__vars['xf']['visitor']['alerts_unread'], array(array('number', array()),), true) . '"
										data-xf-click="menu"
				...
				'href' => '',
									...
									<a href="' . $__templater->fn('link', array('conversations', ), true) . '"
										...
										data-menu-pos-ref="< .p-navgroup"
									    aria-label="' . $__templater->filter('Hộp thư', array(array('for_attr', array()),), true) . '"
										aria-expanded="false"
										aria-haspopup="true">
			...
			if ($__templater->method($__vars['xf']['visitor'], 'canStartConversation', array())) {
				$__compilerTemp4 .= '
													<span class="menu-footer-opposite">
														<a href="' . $__templater->fn('link', array('conversations/add', ), true) . '">' . 'Bắt đầu trò chuyện mới' . '</a>
													</span>
												';
			}
			$__compilerTemp4 .= '
		...
		if ($__templater->fn('property', array('dt_triggers_style', ), false) == 'option2') {
			$__compilerTemp4 .= '
									<a href="' . $__templater->fn('link', array('login', ), true) . '" class="p-navgroup-link p-navgroup-link--iconic p-navgroup-link--logIn" data-xf-click="menu">
										<i></i>
			...
			'_type' => 'option',
										...
										<div class="menu-row">
											<div class="inputGroup">
												...
												<input type="text" class="input" name="c[users]" data-xf-init="auto-complete" placeholder="' . $__templater->filter('Thành viên', array(array('for_attr', array()),), true) . '" aria-labelledby="ctrl_search_menu_by_member" />
											</div>
										</div>
					...
					<div class="p-nav-opposite">
						...
						<div class="p-navgroup p-discovery' . ((!$__templater->method($__vars['xf']['visitor'], 'canSearch', array())) ? ' p-discovery--noSearch' : '') . '">
							<a href="' . $__templater->fn('link', array('whats-new', ), true) . '"
							    ...
							    aria-label="' . $__templater->filter('Có gì mới?', array(array('for_attr', array()),), true) . '"
								title="' . $__templater->filter('Có gì mới?', array(array('for_attr', array()),), true) . '">
								<i aria-hidden="true"></i>
	...
	$__finalCompiled .= '
			...
			';
	if ($__templater->fn('property', array('publicNavSticky', ), false) == 'all') {
		$__finalCompiled .= '
				';
		$__compilerTemp7 = '';
...
<div class="p-body">
	...
	<div class="p-breadcrumbs--container' . ($__vars['sidebar'] ? ' p-breadcrumbs--container--side' : '') . '">
		...
		'selectedNavEntry' => $__vars['selectedNavEntry'],
			...
			';
	if ($__vars['sidebar']) {
		if ($__templater->fn('property', array('dt_collapsible_sidebar', ), false) AND ((!$__templater->fn('property', array('dt_disable_sidebar', ), false)) AND $__vars['sidebar'])) {
			$__finalCompiled .= '<span id="collapse-side" class="collapseTrigger collapseTrigger--block ' . ((!$__templater->fn('is_toggled', array('_side-1', ), false)) ? ' is-active' : '') . '" data-xf-click="toggle" data-xf-init="toggle-storage" data-storage-type="cookie" data-target=".p-body-sidebar, .p-body-content" data-storage-key="_side-1"></span>';
		}
	}
	$__finalCompiled .= '
		</div>
		...
		if (!$__vars['xf']['visitor']['user_id']) {
			$__finalCompiled .= '
				<div class="p-guest--message">
					' . $__templater->fn('property', array('dt_guest_message_content', ), true) . '
				</div>
			';
		}
		$__finalCompiled .= '	
	...
	$__finalCompiled .= '
			...
			<div class="p-body-content ' . ((!$__templater->fn('is_toggled', array('_side-1', ), false)) ? 'is-active' : '') . '">
				
				';
	if (($__vars['template'] == 'forum_list') AND $__templater->fn('property', array('dt_featpost', ), false)) {
		$__finalCompiled .= '
				<div class="featPost">
					<div class="featPost__img">
						<img src="' . $__templater->fn('property', array('dt_featpost__img', ), true) . '" alt="' . $__templater->fn('property', array('dt_featpost__title', ), true) . '" >
					</div>
					<div class="featPost__content">
						<h3><a href="' . $__templater->fn('property', array('dt_featpost__link', ), true) . '">' . $__templater->fn('property', array('dt_featpost__title', ), true) . '</a></h3>
						<ul class="listInline listInline--bullet">
							<li>Posted by: ' . $__templater->fn('property', array('dt_featpost__authorname', ), true) . '</li>
							<li><time class="u-dt">' . $__templater->fn('property', array('dt_featpost__time', ), true) . '</time></li>
						</ul>
					</div>
				</div>
				';
	...
	$__finalCompiled .= '
				...
				';
	if (($__vars['template'] == 'forum_list') AND $__templater->fn('property', array('dt_featposts', ), false)) {
		$__finalCompiled .= '
				<div class="featPosts">
					<div class="featPosts__head"><span>Featured</span>Posts</div>
					<div class="featPosts__container">
						<div class="featPosts__item">
							<img src="' . $__templater->fn('property', array('dt_featpost1__img', ), true) . '" alt="' . $__templater->fn('property', array('dt_featpost1__title', ), true) . '" >
							<h3><a href="' . $__templater->fn('property', array('dt_featpost1__link', ), true) . '">' . $__templater->fn('property', array('dt_featpost1__title', ), true) . '</a></h3>
							<ul class="listInline listInline--bullet">
								<li><time class="u-dt">' . $__templater->fn('property', array('dt_featpost1__time', ), true) . '</time></li>
								<li>' . $__templater->fn('property', array('dt_featpost1__author', ), true) . '</li>
							</ul>
						</div>
						<div class="featPosts__item">
							<img src="' . $__templater->fn('property', array('dt_featpost2__img', ), true) . '" alt="' . $__templater->fn('property', array('dt_featpost2__title', ), true) . '" >
							<h3><a href="' . $__templater->fn('property', array('dt_featpost2__link', ), true) . '">' . $__templater->fn('property', array('dt_featpost2__title', ), true) . '</a></h3>
							<ul class="listInline listInline--bullet">
								<li><time class="u-dt">' . $__templater->fn('property', array('dt_featpost2__time', ), true) . '</time></li>
								<li>' . $__templater->fn('property', array('dt_featpost2__author', ), true) . '</li>
							</ul>
						</div>
						<div class="featPosts__item">
							<img src="' . $__templater->fn('property', array('dt_featpost3__img', ), true) . '" alt="' . $__templater->fn('property', array('dt_featpost3__title', ), true) . '" >
							<h3><a href="' . $__templater->fn('property', array('dt_featpost3__link', ), true) . '">' . $__templater->fn('property', array('dt_featpost3__title', ), true) . '</a></h3>
							<ul class="listInline listInline--bullet">
								<li><time class="u-dt">' . $__templater->fn('property', array('dt_featpost3__time', ), true) . '</time></li>
								<li>' . $__templater->fn('property', array('dt_featpost3__author', ), true) . '</li>
							</ul>
						</div>
						<div class="featPosts__item">
							<img src="' . $__templater->fn('property', array('dt_featpost4__img', ), true) . '" alt="' . $__templater->fn('property', array('dt_featpost4__title', ), true) . '" >
							<h3><a href="' . $__templater->fn('property', array('dt_featpost4__link', ), true) . '">' . $__templater->fn('property', array('dt_featpost4__title', ), true) . '</a></h3>
							<ul class="listInline listInline--bullet">
								<li><time class="u-dt">' . $__templater->fn('property', array('dt_featpost4__time', ), true) . '</time></li>
								<li>' . $__templater->fn('property', array('dt_featpost4__author', ), true) . '</li>
							</ul>
						</div>
					</div>
				</div>
	...
	if ($__vars['sidebar']) {
		$__finalCompiled .= '
				<div class="p-body-sidebar ' . ((!$__templater->fn('is_toggled', array('_side-1', ), false)) ? 'is-active' : '') . '">
...
';
	if ($__templater->fn('property', array('dt_extra_footer', ), false)) {
		$__finalCompiled .= $__templater->includeTemplate('extra_footer', $__vars);
	}
	$__finalCompiled .= '
...
<footer class="p-footer" id="footer">
	...
	if (strlen(trim($__compilerTemp12)) > 0) {
		...
		if ($__vars['xf']['helpPageCount']) {
			$__finalCompiled .= '
							<li><a href="' . $__templater->fn('link', array('help', ), true) . '">' . 'Trợ giúp' . '</a></li>
						';
		}
		$__finalCompiled .= '
	...
	$__compilerTemp13 .= '
				...
				' . $__templater->callback('DBTech\\Credits\\Template\\Callback\\Copyright', 'getCopyrightText', '', array()) . '
						' . '' . '
' . $__templater->fn('liamwCopyright', array(), true) . '
					';
	if (strlen(trim($__compilerTemp13)) > 0) {
		$__finalCompiled .= '
					...
					' . $__compilerTemp13 . '
						<br />
						Phát triển <i class="fa fa-heart animate-pulse"></i> bởi: <a href="/">LifeOfLip</a>
					</div>
				';
	}
	$__finalCompiled .= '
...
';
	...
	<div class="u-scrollButtons js-scrollButtons" data-trigger-type="' . $__templater->fn('property', array('scrollJumpButtons', ), true) . '">
		' . $__templater->button($__templater->fontAwesome('fa-chevron-up', array(
		...
		if ($__templater->fn('property', array('scrollJumpButtons', ), false) != 'up') {
			$__finalCompiled .= '
			' . $__templater->button($__templater->fontAwesome('fa-chevron-down', array(
